...
namespace Bloom.Browser.LibraryModule.Services
{
    public class LibraryService : ILibraryService
    {
        ...
        public LibraryService(IEventAggregator eventAggregator, IRegionManager regionManager, IUserService userService, ISharedLibraryService sharedLibraryService, ILibraryRepository libraryRepository)
        {
